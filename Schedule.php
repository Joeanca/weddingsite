		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<!--<h2>Join Us</h2>-->
					<p>We chose a destination wedding because it means we get to spend a whole week with the people we love. Come hang out with us!</p>
					<p>Throughout the week we’ll be at the beach or at the pool.</p>
                    <p>We will also be gathering as a group for the following events:</p>
				</div>
			</div>
			<div class="row">
						...
						<li id="day1" class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Welcome cocktails</h3>
									<span class="date">May 6 2018, 6 pm</span>
								</div>
								<div class="timeline-body">
			    					<p>Tequila Lobby Bar at Tropical<br />No dress code</p>
								</div>
							</div>
						</li>
						<li id="day2" class="animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="date">May 10th 2018 5:00 pm- 6:00</span>
								</div>
								<div class="timeline-body">
									 <p>Ceremony 5:00pm<br /> Cocktails 6:00pm<br /> Reception 8:00pm<br /> Dress code: Beach formal</p>
                                </div>
							</div>
						</li>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block" id="date"></small> 
