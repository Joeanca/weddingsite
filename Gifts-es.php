		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<h2>Gracias</h2>
					<span>Le agradecemos por unirse a nosotros y entendemos que es un gasto significativo. Por favor, no se sienta obligado a darnos un regalo.<br></span>
					<span><br>Sin embargo, si se siente generoso y porque traer un microondas en un avión puede ser difícil; aquí hay algunas maneras de hacernos llegar su regalo.</span>
				</div>
			</div>
			<div class="row">
				<div class="display-t">
						...
						<div class="col-md-10 col-md-offset-1">
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<p>Esta es una forma sencilla de enviarnos un regalo a través de Internet. <a href=""><u>haga clic aquí</u></a></p>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<p>Probablemente la forma más fácil. Disponible en su Jorge o Marina más cercano</p>
								</div>
							</div>
						</div>
					</div>
