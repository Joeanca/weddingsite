		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<!--<h2>Join Us</h2>-->
					<p>Elegimos una boda de destino porque significa que podemos pasar una semana entera con la gente que amamos. ¡Ven a pasar el rato con nosotros!</p>
					<p>Durante toda la semana estaremos en la playa o en la piscina.</p>
                    <p>También nos reuniremos en grupo para los siguientes eventos:</p>
				</div>
			</div>
			<div class="row">
						...
						<li id="day1" class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Cócteles de bienvenida</h3>
									<span class="date">Mayo 6 2018, 6 pm</span>
								</div>
								<div class="timeline-body">
			    					<p>Tequila Lobby Bar en Tropical <br /> No hay código de vestimenta</p>
								</div>
							</div>
						</li>
						<li id="day2" class="animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="date">Mayo 10th 2018 5:00 pm- 6:00</span>
								</div>
								<div class="timeline-body">
									 <p>Ceremonia 5:00pm<br /> Cocktails 6:00pm<br /> Recepción 8:00pm<br /> Código de vestimenta: Playa formal</p>
                                </div>
							</div>
						</li>
