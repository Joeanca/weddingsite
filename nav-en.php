<nav class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="row">
				<div class="col-xs-2">
                    <div id="fh5co-logo"><a href="home.php"><div id="logo-container"><span id="logo-span" style="width:4em;">m<img id="heart" class="animate-box" src="images/heart.jpg" alt="heart">j<strong>.</strong></span></div></a></div>
				</div>
				<div class="col-xs-10 text-right menu-1">
					<ul>
						<li><a href="home.php" class="en" lang="en-CA">Home</a></li>
                        ...
                        <li class="has-dropdown">
							...
							<ul class="dropdown">
								<li><a href="Schedule.php#day1" onclick="$.scrollTo($('#myDiv'), 1000);">Cocktails</a></li>
								<li><a href="Schedule.php#day2">The Wedding</a></li>
							</ul>
						</li>
