				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h2>Encuentre nuestros momentos especiales aqui</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<h2>Galeria de boda</h2>
					<p>Encuentre nuestros momentos especiales aqui agrupados por ocasión. Después de la boda y luna de miel vamos a publicar las fotos aquí</p>
				</div>
			</div>
                                ...
                                <figure>
                                    <a href="engagementParty/189_2.jpg" class="color-2" data-size="320x480"  style="background: url(engagementParty/189_2.jpg) no-repeat center center border-box; background-size:cover" >
                                        <div class="case-studies-summary">
                                            ...
                                            <h2>Nuestra fiesta de compromiso</h2>
                                        </div>
                                        <img src="engagementParty/189_2.jpg" alt="Image description" style="width:320px; height:480px; display:none;">
