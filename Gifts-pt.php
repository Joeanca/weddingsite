		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<h2>Obrigado</h2>
					<span>Agradecemos por se juntar a nós e entendemos que é uma despesa significativa. Por favor, não se sinta obrigado a nos dar um presente.<br></span>
					<span><br>No entanto, se você se sentir generoso e porque trazer um microondas em um avião pode ser difícil; aqui estão algumas maneiras de obter o seu presente.</span>
				</div>
			</div>
			<div class="row">
				<div class="display-t">
						...
						<div class="col-md-10 col-md-offset-1">
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<p>Esta é uma maneira simples de nos enviar um presente através da internet. <a href=""><u>Clique aqui</u></a></p>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<p>Provavelmente a maneira mais fácil. Disponível no seu Jorge ou Marina mais próximo</p>
								</div>
							</div>
						</div>
					</div>
