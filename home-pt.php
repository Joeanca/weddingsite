				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
                            ...
                            <div title="Adicionar ao Calendário" class="addeventatc ">
							Adicionar ao Calendário                                <span class="start">05/10/2018 05:00 PM</span>
                                <span class="end">05/10/2087 11:59 AM</span>
                                <span class="timezone">America/Cancun</span>
                                <span class="title">Casamento de Jorge e Marina</span>
                                <span class="description">Estamos entusiasmados em celebrar o nosso casamento<br>Estamos ansiosos para compartilhar esta ocasião especial com você.</span>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h2 class="en">Ben-vindo</h2>
					<h3>Maio 10th, 2018 Mexico</h3>
					<p>Compartilhe nosso casamento com a gente</p>
				</div>
			</div>
			<div class="couple-wrap animate-box">
				<div class="couple-half">
					...
					<div class="desc-groom">
						<h3>Jorge Castano</h3>
						<p>Um colombiano / canadense que se apaixonou por uma mulher incrível. </p>
					</div>
				</div>
					...
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
                            ...
                            <div title="Add to Calendar" class="addeventatc ">
                                ...
                                <span class="end">05/10/2087 11:59 AM</span>
                                <span class="timezone">America/Cancun</span>
                                <span class="title">Jorge and Marina's wedding</span>
                                <span class="description">We are exited to celebrate our weeding<br>we are looking forward to sharing this special occasion with you.</span>
                                <span class="location">Carretera Chetumal-Puerto Juárez Km. 266.3, Riviera Maya, 77750 Playa del Carmen, Q.R., Mexico</span>
                                <span class="organizer">Jorge and Marina</span>
                                <span class="all_day_event">false</span>
                                <span class="date_format">MM/DD/YYYY</span>
